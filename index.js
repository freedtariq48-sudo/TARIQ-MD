            ...
            if (connection === 'open') {
                ...
                setTimeout(() => {
                    ...
                    conn.sendMessage(ownerNumber[0] + '@s.whatsapp.net', {
                        text: `✅ *TARIQ-HACKER-MD ACTIVATED*\n\nBot is now online!\nCommands: ${commands.length}\nPrefix: ${prefix}`
                    }).catch(() => {});
                }, 5000);
            }
        });
...
console.log("\n🚀 ==============================");
console.log("🚀 TARIQ-HACKER-MD BOT STARTING...");
console.log("🚀 ==============================\n");
